...
mo    '''
  ...
  def dielectric_tensor ( self, metal=False, temp=None, delta=0.01, deltaint=0.01, emin=0., emax=10., ne=500, d_tensor=None ):
    '''
...
#    if 'deltaint' not in attr: attr['deltaint'] = deltaint
    if d_tensor is not None: arrays['d_tensor'] = np.array(d_tensor)
    
    attr['delta'] = delta
    attr['deltaint'] = deltaint
